...
class DetachController extends AbstractController
{
    ...
    /**
     * @Route("/detach/{network}/{networkId}", name="profile.oauth.detach", methods={"DELETE"})
     ...
     * @return Response
     */
    public function detach(Request $request, string $network, string $networkId, Handler $handler): Response
    {
